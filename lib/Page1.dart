                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Column(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              Image.network("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS9KXiLrGSXDYPZmgHpR4boX0iJIP0A0SK2VA&usqp=CAU",height: 80,),
                              Text("Dr Jennifer Hart", style: TextStyle(fontSize: 20),),
                              Text("Dentiste", style: TextStyle(color: Colors.black.withOpacity(0.5)),),
                              ElevatedButton(onPressed: (){
                                Navigator . push (
                                  context , MaterialPageRoute ( builder : ( context ) => const Page4()), );
